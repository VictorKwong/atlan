...
import { WinResultFn, ResetEnemyCurrentHealthFn, UserLevelUpFn, BossEclipseDefeatFn} from './actions';
...
let obtain = false;
const EtcBox = [
  {id: 0, num: 5, name: "Four Leaf Clover", img: FourLeafClover , percent: 1, Gain: WinFourLeafCloverFn},
  {id: 1, num: 5, name: "Glass Bead", img: GlassBead , percent: 0.8, Gain: WinGlassBeadFn},
  {id: 2, num: 5, name: "Opal", img: Opal , percent: 0.5, Gain: WinOpalFn},
]
            ...
            <div className="storyMapScreen">
              <div className="battleScreen">
                <div className="enemyBox"> 
                    ...
                    {
                      i === 5 ? <img className={ImageControlRoom.EnemyOnHit ? `onHitAnimate imgFlip` : `imgFlip`} src={ImageControlRoom.EnemyOnHit ? EclipseHit : ImageControlRoom.EnemyAttack ? EclipseAttack : ImageControlRoom.EnemyDead ? EclipseDead : Eclipse } alt={enemyStats[i].name} /> :
                      null
                    }                    
