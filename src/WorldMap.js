...
function StartMenu(){
    ...
    let WeaponGearBox = [
      ...
      BonusSTR:7, BonusAGI:0, BonusVIT:0, BonusINT:0, BonusDEX:0, BonusLUK:0, Bonusattack:777, Bonusspeed:7, BonusdodgeRate:0.7, Bonusdefence:77, Bonusdefencebuffer:77, BonushitRate:0.7, BonuscritRate:0.7, BonusHealth:0, BonusSP:0}
    ]
    let HeadGearBox = [
      ...
      BonusSTR:3, BonusAGI:0, BonusVIT:0, BonusINT:0, BonusDEX:0, BonusLUK:0, Bonusattack:0, Bonusspeed:0, BonusdodgeRate:0, Bonusdefence:0, Bonusdefencebuffer:0, BonushitRate:0, BonuscritRate:0, BonusHealth:0, BonusSP:0},
      ...
      BonusSTR:0, BonusAGI:0, BonusVIT:0, BonusINT:20, BonusDEX:0, BonusLUK:0, Bonusattack:0, Bonusspeed:0, BonusdodgeRate:0, Bonusdefence:0, Bonusdefencebuffer:0, BonushitRate:0, BonuscritRate:0, BonusHealth:0, BonusSP:0},
      ...
      BonusSTR:0, BonusAGI:0, BonusVIT:5, BonusINT:0, BonusDEX:0, BonusLUK:0, Bonusattack:0, Bonusspeed:0, BonusdodgeRate:0, Bonusdefence:0, Bonusdefencebuffer:0, BonushitRate:0, BonuscritRate:0, BonusHealth:0, BonusSP:0},
      ...
      BonusSTR:10, BonusAGI:10, BonusVIT:10, BonusINT:10, BonusDEX:10, BonusLUK:10, Bonusattack:0, Bonusspeed:0, BonusdodgeRate:0, Bonusdefence:0, Bonusdefencebuffer:0, BonushitRate:0, BonuscritRate:0, BonusHealth:0, BonusSP:0},
    ]
    let ArmorGearBox = [
      ...
      BonusSTR:4, BonusAGI:0, BonusVIT:0, BonusINT:0, BonusDEX:0, BonusLUK:0, Bonusattack:0, Bonusspeed:0, BonusdodgeRate:0, Bonusdefence:0, Bonusdefencebuffer:0, BonushitRate:0, BonuscritRate:0, BonusHealth:0, BonusSP:0},
    ]
    let GarmentBox = [
    ...
    const WeaponEquipmentAttribute = (BonusSTR, BonusAGI, BonusVIT, BonusINT, BonusDEX, BonusLUK, EquipItem, UnEquipItem, BonusAttack, BonusSpeed, BonusDodgeRate, BonusDefence, BonusDefenceBuffer, BonusHitRate, BonusCritRate, BonusHealth, BonusSP) => {
      dispatch(BonusEquipPointsFn(userAttribute.BonusStr + BonusSTR - STRBufferWeapon, userAttribute.BonusAgi + BonusAGI - AGIBufferWeapon, userAttribute.BonusVit + BonusVIT - VITBufferWeapon, userAttribute.vit, userAttribute.BonusInt + BonusINT - INTBufferWeapon, userAttribute.int, userAttribute.BonusDex + BonusDEX - DEXBufferWeapon, userAttribute.BonusLuk + BonusLUK - LUKBufferWeapon, BonusSTR - STRBufferWeapon, BonusAGI - AGIBufferWeapon, BonusVIT - VITBufferWeapon, BonusINT - INTBufferWeapon, BonusDEX - DEXBufferWeapon, BonusLUK - LUKBufferWeapon, BonusAttack, BonusSpeed, BonusDodgeRate, BonusDefence, BonusDefenceBuffer, BonusHitRate, BonusCritRate, BonusHealth, BonusSP));
      // Note Training = BonusSTR - STRBuffer
      // BonusSTRPointFn = Update Stats
