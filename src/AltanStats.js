    ...
    return(
      <div className="AltanStatsMap">
        ...
        <div className="statsDescriptDetails">
            ...
            <p className="def4">{Math.floor(userStats.defence)} + {userStats.BaseHeadGearDef + userStats.BaseArmorDef + userStats.BaseFootGearDef + userStats.BaseGarmentDef+ userStats.BaseAccessoryOneDef + userStats.BaseAccessoryTwoDef + userStats.Bonusdefence}</p>
