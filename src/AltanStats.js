...
function StartMenu(){
    ...
    let SkillBox = [
      ...
      {id:20005, Img:skillQuicken, name:"Quicken", skillLevelCheck:1, title:"Increase speed by 10 for 5 turns"},
      {id:20006, Img:skillBowlingBash, name:"BowlingBash", skillLevelCheck:1, title:"Deal damage to enemy"},
    ]
    let GuildBox = [
