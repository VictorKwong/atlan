...
function StartMenu(){
    ...
    let SkillBox = [
      ...
      {id:20004, Img:skillMagnum, name:"Magnum Break", skillLevelCheck:skillCapChart.MagnumBreakSkillLevel, selection:MagnumBreakTrainingFn(), title:`SP:${skillCapChart.SPMagnumBreak} - Instant fire-property Skill +Accuracy (OnHit) | +20%FireAttack`},
