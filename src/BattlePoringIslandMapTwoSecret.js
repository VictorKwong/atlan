...
let obtain = false;
const EtcBox = [
  {id: 0, num: 4, name: "Emperium", img: Emperium , percent: 1, Gain: WinEmperiumFn},
  {id: 1, num: 4, name: "Fabric", img: Fabric , percent: 0.8, Gain: WinFabricFn},
]
            ...
            <div className="storyMapScreen">
              <div className="battleScreen">
                <div className="enemyBox"> 
                    ...
                    {
                      i === 4 ? <img className={ImageControlRoom.EnemyOnHit ? `onHitAnimate imgFlip` : `imgFlip`} src={ImageControlRoom.EnemyOnHit ? GhostringHit : ImageControlRoom.EnemyAttack ? GhostringAttack : ImageControlRoom.EnemyDead ? GhostringDead : Ghostring } alt={enemyStats[i].name} /> :
                      null
                    }                    
