...
import {GotoPronteraSouthGateFn ,finishStoryLineOneFn, typeWritterEffectFn} from './actions';
...
function StartMenu(){
    ...
    return(
      <div>
        ...
        screenControlRoom.PronteraSouth ? <WorldMap/> :
        <div>
          <div className="storyMapScreen">
            <div className="PronteraMap">
              ...
              <button className="pronteraSouthGate" onClick={() => {dispatch(GotoPronteraSouthGateFn()); changeMapFadeAudio();}}>PronteraSouthGate</button>
            </div>
