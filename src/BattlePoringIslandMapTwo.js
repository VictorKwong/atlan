...
let Damage = 0;
//Monster Random Number 2,3
let i = Math.floor(Math.random() * 2) + 2;
let Uclock = 0;
let clockCheck = 0;
...
let obtain = false;
const EtcBox = [
  {id: 0, num: 2, name: "GrasshoppersLeg", img: GrasshoppersLeg , percent: 0.95, Gain: WinGrasshoppersLegFn},
  {id: 1, num: 3, name: "Snail`s Shell", img: SnailsShell , percent: 0.9, Gain: WinSnailsShellFn},
  {id: 2, num: 3, name: "Shell", img: Shell , percent: 0.3, Gain: WinShellFn},
  {id: 3, num: 3, name: "Garlet", img: Garlet , percent: 0.12, Gain: WinGarletFn},
]
            ...
            <div className="storyMapScreen">
              <div className="battleScreen">
                <div className="enemyBox"> 
                    ...
                    {
                      i === 2 ? <img className={ImageControlRoom.EnemyOnHit ? `onHitAnimate imgFlipTwo` : `imgFlipTwo`} src={ImageControlRoom.EnemyOnHit ? RockerHit : ImageControlRoom.EnemyAttack ? RockerAttack : ImageControlRoom.EnemyDead ? RockerDead : Rocker } alt={enemyStats[i].name} /> :
                      i === 3 ? <img className={ImageControlRoom.EnemyOnHit ? `onHitAnimate imgFlipTwo` : `imgFlipTwo`} src={ImageControlRoom.EnemyOnHit ? AmberniteHit : ImageControlRoom.EnemyAttack ? AmberniteAttack : ImageControlRoom.EnemyDead ? AmberniteDead : Ambernite } alt={enemyStats[i].name} /> :
                      null
                    }                    
