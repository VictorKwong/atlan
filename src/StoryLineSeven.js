      ...
      <div>
        ...
        <div className="storyScreenStoryLineSevenBackground">
          ...
          <p className="storySpeech">Arhhhhhhhh......</p>
            ...
            <div>
              <button className={(storyLineOne['storyLineSeven'].length === textReadAndSpeed.count) ? "SkipButton SkipButtonPositon SkipButtonContinue" : "SkipButton SkipButtonPositon"} onClick={() => {LoadingScreen2();}}>Skip</button>
            </div>
          </fieldset>
        </div>
        }
